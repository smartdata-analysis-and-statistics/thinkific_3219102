...
You should obtain an effect size of approximately `r est_mixed` in favor of Semaglutide, with a 95% confidence interval of (`r format(ci_mixed[1], digits = 2, nsmall = 2)`, `r format(ci_mixed[2], digits = 2, nsmall = 2)`). 
